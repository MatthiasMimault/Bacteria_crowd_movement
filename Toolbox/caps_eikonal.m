function [Phi] = caps_eikonal(X,Y,PhiBd, PhiAt)
% CAPS_EIKONAL Summary of this function goes here
% Solve the eikonal equation with the fast sweeping method, for
% 1. Cartesian grid
% 2. Non-Cartesian grid
% 3. w Obstactles
% PhiBd is the obstacle matrix, PhiAt is the target matrix
