...
%         NSave+1
        ...
        b = fUpdateX2(b,Dt,Dx,A,Vx,PhiDef,PhiAt,PhiBd);  
        ...
        b = fUpdateY2(b,Dt,Dy,A,Vy, PhiDef, PhiAt, PhiBd);
    ...
    b = fDiffusionX(b,Dt,Dx,C,PhiDef,PhiBd); 
    b = fDiffusionY(b,Dt,Dy,C,PhiDef,PhiBd); 
    plotSurf(X,Y,b,0,0,Axis)
    max(max(b))
    min(min(b))
    pause
